...
import { ListaCategoriasDentalesComponent } from './lista-categorias-dentales/lista-categorias-dentales.component';
import { FormCategoriaDentalComponent } from './form-categoria-dental/form-categoria-dental.component';

@Component({
  selector: 'app-gestion-categorias-dentales',
  standalone: true,
  imports: [CommonModule, ListaCategoriasDentalesComponent, FormCategoriaDentalComponent],
  templateUrl: './gestion-categorias-dentales.component.html',
  styleUrl: './gestion-categorias-dentales.component.css'
})
export class GestionCategoriasDentalesComponent implements OnInit {
  ...
  constructor(private categoriasService: CategoriasDentalesService) {}
