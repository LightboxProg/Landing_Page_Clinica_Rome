...
@Component({
  selector: 'app-modal-servicio-dental',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './modal-servicio-dental.component.html',
  styleUrl: './modal-servicio-dental.component.css'
})
export class ModalServicioDentalComponent {
  @Input() visible = false;
  ...
  onGuardar(): void {
    ...
    if (this.fotoSeleccionada) fd.append('fotos', this.fotoSeleccionada, this.fotoSeleccionada.name);
